...
public class CommandeDaoImpl implements CommandeDao {
    ...
    private static final String SQL_UPDATE_PAR_ID = "UPDATE Commande SET id_client = ?, montant = ?, mode_paiement = ?, statut_paiement = ?, mode_livraison = ?, statut_livraison = ? WHERE id = ?"; 
    ...
    public void modifier( Commande commande ) throws DAOException {
        ...
        try {
            ...
            preparedStatement = initialisationRequetePreparee( connexion, SQL_UPDATE_PAR_ID, true,
                    ...
                    commande.getMontant(),
                    commande.getModePaiement(), commande.getStatutPaiement(),
                    commande.getModeLivraison(), commande.getStatutLivraison(), commande.getId() );
            int statut = preparedStatement.executeUpdate();
            if ( statut == 0 ) {
